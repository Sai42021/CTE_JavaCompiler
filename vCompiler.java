...
public class vCompiler {
        // TODO: Semi colon error handling
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= strNums; i++) {
            ...
            for (int j = 0; j < splitStr.length; j++) {
                ...
                // Syntax Errors/ Semi colon error
                ...
                if(input.equals("+*") || input.equals("-/") || input.equals("*/") || input.equals("*+") || input.equals("/*") || input.equals("*-") || input.equals("-*") || input.equals("+/") || input.equals("/+")) {
                    if (!uniqueKeywords.contains(input)) {
                        uniqueKeywords.add(input);
