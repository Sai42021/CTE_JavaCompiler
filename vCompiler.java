...
public class vCompiler {
    ...
    public static void main(String[] args) {
        ...
        strnum1 = strE26.replace("digit1", "1");
            ...
            strnum6 = strnum4.replace("digit6", "6");
            ...
            System.out.println("CONCLUSION-->This expression: " + str + " is Syntactically and Sematically correct");
